    ...
    <xsl:template name="noChapter">
        <xsl:if test="//TEI:body[@xml:id]">
            <div style="margin: 0.5em">
                <div><a href="html/1829_481A_img.html" target="_blank" style="text-decoration: none">Klik her for at se <i>Tidens Ström</i></a>. Dette værk vises i et nyt vindue.</div>
